...
//    	driver.findElement(By.id("btnSIGNIN")).click();
	...
	public static Object[][] EnterData() throws Exception
	{
		...
		Object data[][]= obj.cbsedata("CBSEDELHI");
		return data;
	...
	public void setData(String Board, String YoP, String Type, String Roll, String Photo, String AName, String FName, String MName, String Blood, String Gender, String Religion, 
			...
			String FirstElectiveE, String SecondElectiveE, String ThirdElectiveE, String FirstChoiceE, String SecondChoiceE, String ThirdChoiceE
			) throws Exception
	{
...
//		driver.findElement(By.id("btnSave")).click();
		...
		driver.findElement(By.id("btnSave")).click();
		Thread.sleep(2000);
		String exptext = "You have entered 5 option. \n Click OK to submit.\n Click Cancel to modify.";
